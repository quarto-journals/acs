...
the `achemso` class.  These are mainly concerned with content,
...
database file `bibliography.bib` shows how to complete
entries correctly. 

Multiple citations to be combined into a list can be given as
a single citation.  This uses the `mciteplus` package.
