...
format:
  quarto-journals/acs-pdf:
    journal:
      id: jacsat  #This is an identifier for the target jour- nal: from https://pubs.acs.org/, the identifier is the part of the URL after https://pubs.acs.org/journal/, e.g. for J. Org. Chem. it would be joceah.
